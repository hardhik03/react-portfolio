  ...
  return (
    <section className="flex flex-col lg:flex-row items-center justify-center min-h-[80vh] w-full px-8">
      ...
      <div className="flex-1 flex flex-col justify-center lg:items-start items-center text-left lg:pr-12">
        ...
        <h2 className="text-2xl lg:text-3xl font-normal bg-clip-text mb-6 leading-tight">
      ...
      />
        ...
        initial='hidden'
        animate='visible'className="text-base lg:text-lg text-gray-300 max-w-xl">
            <span>I’m Hardhik, an Electrical Systems Engineer specializing in power electronics, renewable integration, Electric Vehicles and of course Electrical Systems. My </span>
            <span className='text-purple-500 font-semibold text-xl'>Passion ?</span> Designing solutions that don’t just work, they transform how we use energy. </motion.p>
      </div>
      {/* Right: Image */}
